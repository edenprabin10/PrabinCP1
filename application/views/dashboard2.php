...
<head>
    ...
    <script type="text/javascript" src="<?php echo base_url();?>assets/js/main_2.js"></script>
</head>
<body>
	...
	<header>
		<div class="wrapper">
			<div class="logo">
				<a href=""><img src="<?php echo base_url();?>assets/img/logo.png" alt="Resto" title=""/></a>
			</div>
	...
	<section class="featured_dishes">
		<div class="wrapper">
			...
			<section class="dishes" id="dishes">
				...
				<article>
					<div class="dishe_img">
						<a href="#"><img src="<?php echo base_url();?>assets/img/dish1.jpg" alt="" title=""/></a>					
					</div>
					<div class="dish_info">
				...
				<article>
					<div class="dishe_img">
						<a href="#"><img src="<?php echo base_url();?>assets/img/dish2.jpg" alt="" title=""/></a>					
					</div>
					<div class="dish_info">
				...
				<article>
					<div class="dishe_img">
						<a href="#"><img src="<?php echo base_url();?>assets/img/dish3.jpg" alt="" title=""/></a>					
					</div>
					<div class="dish_info">
				...
				<article>
					<div class="dishe_img">
						<a href="#"><img src="<?php echo base_url();?>assets/img/dish4.jpg" alt="" title=""/></a>					
					</div>
					<div class="dish_info">
	...
	<section class="gallery">
		<div class="wrapper">
			...
			<div class="media">
				<section>
					<a href="#">
						<img src="<?php echo base_url();?>assets/img/img1.jpg" alt="" title=""/>
					</a>
				</section>
				...
				<section>
					<div class="hhalf">
						<a href="#">
							<img src="<?php echo base_url();?>assets/img/img2.jpg" alt="" title=""/>
						</a>
					</div>
					<div class="hhalf">
						<a href="#">
							<img src="<?php echo base_url();?>assets/img/img3.jpg" alt="" title=""/>
						</a>
					</div>
				</section>
				...
				<section>
					<div class="hhalf">
						<a href="#">
							<img src="<?php echo base_url();?>assets/img/img4.jpg" alt="" title=""/>
						</a>
					</div>
					<div class="hhalf">
						<a href="#">
							<img src="<?php echo base_url();?>assets/img/img5.jpg" alt="" title=""/>
						</a>
					</div>
				</section>
			</div>
	...
	<footer>
		<div class="wrapper">
			...
			<section class="copyrights">
				<img src="<?php echo base_url();?>assets/img/footer_logo.png" class="footer_logo" alt="" title="">
